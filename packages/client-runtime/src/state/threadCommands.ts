...
export type {
  ...
  ScheduleThreadMessageInput,
  UnscheduleThreadMessageInput,
  SettleThreadInput,
  SnoozeThreadInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    scheduleMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:schedule-message",
      execute: (input: ScheduleThreadMessageInput) => scheduleThreadMessage(input),
      scheduler,
      concurrency,
    }),
