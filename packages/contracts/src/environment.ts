...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server understands thread.message.schedule / thread.message.unschedule
      and sends the parked message itself. Same version-skew contract as
      threadSettlement. */
  threadMessageSchedule: Schema.optionalKey(Schema.Boolean),
